...
const MotherboardPage = ({ cardProduct }) => {
    return (
        <div>
            <Head>
                <title>Motherboard</title>
            </Head>
            <h1 className='text-4xl text-center my-4 font-serif'>Choose <span className='text-info'>Motherboard</span></h1>
...
export const getStaticProps = async () => {
    ...
    const cardProduct = await products?.data?.filter((product) => product?.category === "Motherboard");
