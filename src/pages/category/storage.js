...
const StoragePage = ({ cardProduct }) => {
    return (
        <div>
            <h1 className='text-4xl text-center my-4 font-serif'>Choose <span className='text-info'>Storage</span></h1>
...
export const getStaticProps = async () => {
    ...
    const cardProduct = await products?.data?.filter((product) => product?.category === "Storage");
